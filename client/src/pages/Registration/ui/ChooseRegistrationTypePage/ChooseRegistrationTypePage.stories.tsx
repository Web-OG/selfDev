...
import ChooseRegistrationTypePage from './ChooseRegistrationTypePage';
...
const meta: Meta<typeof ChooseRegistrationTypePage> = {
  title: 'pages/ChooseRegistrationTypePage',
...
type Story = StoryObj<typeof ChooseRegistrationTypePage>;
